...
export default function ProjectLayout({
  ...
  return (
    ...
    w-full overflow-hidden rounded-3xl shadow-lg  transition-all duration-500 ease-in-out text-gray-100 p-5 sm:p-2 flex flex-row sm:flex-col justify-center items-center hover:scale-[101%] transform hover:shadow-2xl gap-5 sm:gap-1 h-full
    `}
      key={productId}
    >
      <section
      ...
      >
        ...
        <div className="py-5 w-full sm:py-1 flex flex-col justify-start items-start sm:items-center">
          <Link
            ...
            className="flex flex-row justify-between items-center bg-gray-400 hover:bg-gray-600 text-2xl text-white font-bold py-3 px-10 sm:px-5 sm:py-2 sm:text-lg transition-all gap-3 hover:gap-5 duration-500 ease-in-out rounded-full"
          >
